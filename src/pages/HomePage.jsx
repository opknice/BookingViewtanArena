        ...
        <section className="welcome-section" style={{ padding: '0rem 1.5rem', maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={{ 
              ...
              สนามฟุตบอลหญ้าเทียมมาตรฐานแห่งใหม่ในจังหวัดเพชรบุรี พร้อมมอบประสบการณ์การเล่นฟุตบอลที่ดีที่สุดให้กับทุกคน ไม่ว่าจะเป็นการเตะกับเพื่อน การแข่งขันฟุตบอล หรือการจัดกิจกรรมกีฬา<br/>
              <br/>
